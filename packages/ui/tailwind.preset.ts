...
// Shared design tokens/theme for both apps/studio and apps/analyst-os.
// Each app's tailwind.config.ts does: presets: [require("@valstine/ui/tailwind.preset")]
export default {
  darkMode: ["class"],
  content: [],
  prefix: "",
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        titlebar: { DEFAULT: "hsl(var(--titlebar))", foreground: "hsl(var(--titlebar-fg))" },
        tab: {
